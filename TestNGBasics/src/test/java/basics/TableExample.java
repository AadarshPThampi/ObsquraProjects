...
/*		  WebElement nameRow = driver.findElement(By.xpath("//table[@id='dtBasicExample']//thead//tr[1]//th[1]")); WebElement
		  positionRow = driver.findElement(By.xpath("//table[@id='dtBasicExample']//thead//tr[1]//th[2]"));
